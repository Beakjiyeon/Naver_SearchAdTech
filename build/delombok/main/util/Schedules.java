...
public class Schedules {
	 ...
	 * 매주 금요일과 토요일에 18시부터 20시까지 노출하고 싶은 경우 <br>
	 *
	 * <pre>
	 * {@code
	 * Schedules.builder()
	...
	public static class ScheduleBuilder {
		...
		public Map<String, Object> build() {
			return DAY_OF_WEEK_MAP.entrySet().stream().collect(Collectors.toMap(Map.Entry::getValue, entry -> schedule.getOrDefault(entry.getKey(), Collections.emptySet()).stream().map(hourOfDay -> 1 << hourOfDay).reduce(0, Integer::sum)));
		}
